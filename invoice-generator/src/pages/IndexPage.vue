  ...
  <div class="invoice-generator">
    <div class="row q-col-gutter-md">
        ...
        <q-card flat bordered class="form-card q-ma-md">
          <q-card-section>
            <div class="form-header">
              <div>
                <div class="text-h5 text-weight-bold">Invoice Generator</div>
            ...
            <div class="row items-center justify-between q-mb-sm">
              ...
              <q-btn flat dense color="primary" icon="add" label="Add Product" @click="addItem" />
            </div>

            <div v-for="(item, idx) in form.items" :key="item.id" class="item-row q-mb-sm">
            ...
            <div class="row q-col-gutter-sm">
              <div class="col-6">
                <q-input
                  v-model="form.paymentCutoffDate"
              ...
              <div class="col-6">
                <q-input
                  v-model="form.paymentCutoffTime"
                  label="Cutoff Time"
                  dense
                  outlined
                  class="q-mb-sm"
            ...
            <q-input v-model="form.courier" label="Courier" dense outlined class="q-mb-sm" />

            <q-separator class="q-my-md" />

            <div class="text-subtitle2 q-mb-sm">Footer Note</div>
            <q-input v-model="form.footerNote" type="textarea" autogrow dense outlined />
          </q-card-section>
        </q-card>
      ...
      <div class="col-xs-12 col-sm-5 col-md-4">
          ...
          <div class="receipt-outer" ref="receiptOuter">
            <div class="receipt-card">
              ...
              <div class="datetime-row">
                {{ formattedDate }} ({{ (form.day || '').toUpperCase() }})&nbsp;&nbsp;{{
                  form.time
                }}
              </div>
              ...
              <div class="kv-row">
                ...
                <div class="mono-bold">
                  {{ form.paymentCutoffDate }} {{ form.paymentCutoffTime }}
                </div>
              </div>
        ...
        <div class="q-pa-md q-ma-md flex justify-center text-grey-5">Tally by dani</div>
      </div>
    </div>
  </div>
</template>
